...
def main():
    ...
    # Ask the user for the SFTP username
    username = input("Enter SFTP username (default: root): ").strip() or "root"

    # Establish SFTP connection to the selected machine
    os.system(f"sftp {username}@{selected_machine['ip']}")
